...
import it.unibo.deis.lia.ramp.core.internode.ContinuityManager; //Stefano Lanzone
...
//    	CheckBox socialConnect;
    	if( ! RampEntryPoint.isActive() ){
            ...
            case R.id.goToClient:
                ...
                try{
                    Class<?> activityClass = Class.forName("it.unibo.deis.lia.ramp.android.service.application."+spinner.getSelectedItem().toString()+"Activity");
            ...
            case R.id.opportunisticNetworkingManagerButton:
        		...
        		if( ! cmConnect.isChecked() ){
        			...
        			try{
                        Class<?> activityClass = Class.forName("it.unibo.deis.lia.ramp.android.service.application.OpportunisticNetworkingManagerActivity");
                        Intent clientIntent = new Intent(
                            RampManagerActivity.this,
                            activityClass
                        );
